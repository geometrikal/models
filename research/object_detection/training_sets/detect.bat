set BASE=D:\Development\VertigoML\tensorflow_models\research\object_detection\training_sets\20200713_cots_brano_with_gopro

set IMAGE=D:\Development\VertigoML\vertigo-processing\vertigo\examples\cots4.jpg

python TFLite_detection_image.py --modeldir %BASE%\models --labels %BASE%\models\labelmap.txt --threshold 0.1 --image %IMAGE%
